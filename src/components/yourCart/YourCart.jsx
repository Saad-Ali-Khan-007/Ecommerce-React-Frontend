...
const YourCart = () => {
  return (
    <div className="mt-10 border-t-4 pt-8 m-auto max-w-[90%]">
      <h1 className="font-extrabold mb-10 text-[2rem]">YOUR CART</h1>
      <div className="flex justify-between">
        <div className="flex border-2 justify-between w-[40%] rounded-2xl p-4">
        ...
        <div>
          <div className="flex gap-4  rounded-2xl border-2 p-4 flex-col justify-between">
            <h1>Order Summary</h1>
            ...
            <button className="bg-black w-[55%] text-white p-[0.6rem] pl-6 pr-6 rounded-full">
              Go to Checkout
            </button>
          </div>
        </div>
